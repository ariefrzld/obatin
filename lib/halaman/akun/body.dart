...
import 'file:///C:/Users/arief/AndroidStudioProjects/obatin_app/lib/halaman/profil/profil.dart';
          ...
          children: <Widget>[
            GestureDetector(
              ...
              child: ListTile(
                ...
                title: Text("Profil", style: GoogleFonts.varelaRound(fontSize: 20.0, fontWeight: FontWeight.w600),),
            ...
            GestureDetector(
              ...
              child: ListTile(
                ...
                title: Text("Notifikasi", style: GoogleFonts.varelaRound(fontSize: 20.0, fontWeight: FontWeight.w600),),
            ...
            GestureDetector(
              ...
              child: ListTile(
                ...
                title: Text("Penilaian Aplikasi", style: GoogleFonts.varelaRound(fontSize: 20.0, fontWeight: FontWeight.w600),),
            ...
            GestureDetector(
              ...
              child: ListTile(
                leading: Icon(Icons.power_settings_new, size: 50.0, color: Colors.redAccent),
                title: Text("Log Out", style: GoogleFonts.varelaRound(fontSize: 20.0, fontWeight: FontWeight.w600),),
